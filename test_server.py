...
async def test_version():
    section("VERSION")
    try:
        assert __version__ == "3.2.6", f"Expected 3.2.6, got {__version__}"
...
async def test_artifact_sign_local_aliases():
    section("artifact_sign local aliases")
    local_signs = {
        "\u0437\u0430\u043c\u0435\u0442\u043a\u0430": "\u03b2",
        "\u043f\u043e\u043d\u044f\u0442\u0438\u0435": "\u03b4",
        "\u0440\u0435\u0444\u0435\u0440\u0435\u043d\u0441": "\u03b6",
        ...
        "\u043d\u043e\u0432\u043e\u0441\u0442\u044c": "\u03bc",
        "\u0433\u0438\u043f\u043e\u0442\u0435\u0437\u0430": "\u03bb",
        "\u0441\u043f\u0435\u0446\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u044f": "\U0001F755",
    }
    cases = [
        ("\u041a\u0440\u0430\u0442\u043a\u0430\u044f \u0437\u0430\u043c\u0435\u0442\u043a\u0430 \u043e \u043d\u0430\u0431\u043b\u044e\u0434\u0435\u043d\u0438\u0438.", "\u03b2"),
        ("\u041f\u043e\u043d\u044f\u0442\u0438\u0435 \u043e\u043f\u0438\u0441\u044b\u0432\u0430\u0435\u0442 \u0441\u0443\u0449\u043d\u043e\u0441\u0442\u044c.", "\u03b4"),
        ("\u041b\u043e\u0433 \u0441\u0435\u0441\u0441\u0438\u0438: \u0441\u043d\u0430\u0447\u0430\u043b\u0430 \u043f\u0440\u043e\u0432\u0435\u0440\u0438\u043b\u0438 \u0431\u0430\u0437\u0443.", "\u03c3"),
        ("\u042d\u0442\u043e \u0433\u0438\u043f\u043e\u0442\u0435\u0437\u0430 \u043e \u0441\u043b\u0430\u0431\u044b\u0445 \u0441\u0432\u044f\u0437\u044f\u0445.", "\u03bb"),
        ("\u0422\u0435\u0445\u043d\u0438\u0447\u0435\u0441\u043a\u0430\u044f \u0441\u043f\u0435\u0446\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u044f \u0434\u043b\u044f \u0430\u0433\u0435\u043d\u0442\u0430.", "\U0001F755"),
    ]
    for content, expected in cases:
        got = determine_artifact_sign(content, {}, local_signs, {}, server.DEFAULT_ARTIFACT_KEYWORDS)
        try:
            assert got == expected, f"{content!r}: expected {expected}, got {got}"
            ok(f"local alias {content[:24]!r} -> {got.encode('unicode_escape').decode()}")
        except AssertionError as e:
            fail("artifact_sign local alias", str(e))
...
async def main():
    ...
    await test_artifact_sign_local_aliases()
